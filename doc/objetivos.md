...
- [X] USAR TAGS SEMANTICAS
- [X] EVITAR USAR CDN, AO INVES DISSO, FAÇA O DOWNLOAD DO QUE FOR UTILIZAR
- [X] AO FAZER O DOWNLOAD, PROCURE APRENDER COMO UILIZAR E CHAMAR
- [] ATUALIZAR O GERAL DO SKELETON - ADICIONE AS CLASSES DO BOTAO, TITULO E BGS
- [] VERIFICAR O MOTIVO DOS ICONES DO FONT AWESOME NÃO ESTAREM FUNCIONANDO
- [] ICONES PADRÕES COM PASTA SVG EM TODOS OS PROJETOS
- [] ATUALIZAR SKELETON COM ESSE CSS
- [] ADICIONAR ANOTAÇÃO NO SKELETO SOBRE AOS
